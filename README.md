...
1-2. Load script(in HTML)|<script src="staticDir/angular-ui-router/release/angular-ui-router.min.js"></script>| N/A
1-3. Dependency injection|```javascript
const app = angular.module('name_of_app', ['ui-router'])```|```javascript import  { Router, Route, browserHistory } from  'react-router'```
